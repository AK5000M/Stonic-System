...
import UploadMainImageFilingForm from "./upload";
// import ReassignFilingForm from "./reassign";

const UploadMainImageFilingContent: React.FC = () => {
	return (
		<SecondaryLayout>
...
export default UploadMainImageFilingContent;
